...
public class Notification {
    ...
    public Notification(String notifierId, String notifierName, String potId, String potName, String toNotifyId, String notifId, int type, String creationDate, int moneyAdded, int previousMoney, int followersNumber) {
